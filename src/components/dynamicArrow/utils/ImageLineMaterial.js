...
//编写glsl部分
Cesium.Material.PolylineTrailLinkSource = `varying float v_polylineAngle;
                                                ...
                                                czm_material czm_getMaterial(czm_materialInput materialInput)
                                                        {
                                                           ...
                                                           float t = st.t;
                                                             vec4 colorImage = texture2D(image, vec2(fract(s - time), t));
...
Cesium.Material._materialCache.addMaterial('ImageLine', {
  fabric: {
    ...
    uniforms: {
      ...
      duration: 3,
      time: 0,
      repeat: new Cesium.Cartesian2(10000, 1.0)
    },
...
export default ImageLineMaterial
