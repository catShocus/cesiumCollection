...
// import ImageLineMaterial from "./utils/classDynamicArrow";
let $viewer;
    ...
    "in float v_polylineAngle;\n\
                                             ...
                                             czm_material czm_getMaterial(czm_materialInput materialInput)\n\
                                                     {\n\
                                                        ...
                                                        float t = st.t;\n\
                                                          vec4 colorImage = texture(image, vec2(fract(s - time), t));\n\
  ...
  let model = $viewer.entities.add({
    polyline: {
      ...
      material: new Cesium.ImageLineMaterialProperty({
        image: "./assest/3365a3fd0f23d571fce6672f010c970.png",
      }), //使用我们自定义的材质
      width: 10,
    },
  });
